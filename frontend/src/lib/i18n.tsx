...
const D: Record<string, Tr> = {
  ...
  // twin
  'twin.title': { uz: 'Raqamli egizakda sinov — simulyatsiya', ru: 'Симуляция на цифровом двойнике', en: 'Digital Twin simulation' },
  'twin.desc': {
    uz: 'Real bemorni davolamasdan, davolashni avval EGIZAKDA sinang: AI bemorning kasallik tarixi va ahvoliga qarab natija, ko‘rsatkich o‘zgarishlari va nojo‘ya ta’sirlarni bashorat qiladi.',
    ru: 'Не леча реального пациента, испытайте лечение на ЦИФРОВОМ ДВОЙНИКЕ: AI прогнозирует результат, изменения показателей и побочные эффекты по истории и состоянию.',
    en: 'Without treating the real patient, test the treatment on the DIGITAL TWIN first: AI predicts the outcome, indicator changes and side effects from history and state.',
  },
  'twin.drug': { uz: 'Dori / davolash', ru: 'Препарат / лечение', en: 'Drug / treatment' },
  'twin.dose': { uz: 'Doza', ru: 'Доза', en: 'Dose' },
  'twin.run': { uz: 'Egizakda sinash', ru: 'Симулировать', en: 'Simulate' },
  'twin.running': { uz: 'Simulyatsiya…', ru: 'Симуляция…', en: 'Simulating…' },
  'twin.effect': { uz: 'Kutilayotgan ta’sir', ru: 'Ожидаемый эффект', en: 'Expected effect' },
  'twin.changes': { uz: 'Ko‘rsatkich o‘zgarishlari', ru: 'Изменения показателей', en: 'Indicator changes' },
  'twin.side': { uz: 'Ehtimoliy nojo‘ya ta’sirlar', ru: 'Возможные побочные эффекты', en: 'Possible side effects' },
